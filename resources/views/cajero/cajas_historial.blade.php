...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center py-3 border-bottom mb-4">
        <div>
            <h1 class="h3 mb-0">
                <i class="bi bi-safe me-2 text-primary"></i>
                Historial de Mis Cajas
            </h1>
            <span class="text-muted">Consulte los cierres y estados de sus turnos pasados.</span>
        </div>
        <div>
    ...
    <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
        ...
        <div class="card-body">
            <form action="{{ route('cajero.cajas.historial') }}" method="GET" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <button type="submit" class="btn btn-primary w-100 fw-bold"><i class="bi bi-search me-1"></i>Buscar</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        @forelse($cajas as $caja)
                            <tr>
                                <td class="ps-4">{{ \Carbon\Carbon::parse($caja->fecha_apertura)->format('d/m/Y H:i') }}</td>
                                <td>
                                ...
                                <td class="text-end pe-4">
                                    ...
                                    @if($caja->estado === 'cerrada')
                                        ...
                                        <button type="button" onclick="imprimirCierreAntiguo(event, '{{ route('cajero.api.imprimir.cierre', $caja->id, false) }}')" class="btn btn-sm btn-dark rounded-pill px-3" title="Imprimir Ticket">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5 text-muted">No tiene registros de cajas todavía.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
