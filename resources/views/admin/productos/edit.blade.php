    ...
    <div class="card-body">
        <form action="{{ route('admin.productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @if($producto->imagen)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $producto->imagen) }}" alt="Imagen actual" style="max-height: 100px; border-radius: 8px;">
                    </div>
                @endif
            ...
            <div class="row mb-3 align-items-end p-3 border rounded bg-light">
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" inputmode="decimal" name="costo" id="costo" class="form-control" value="{{ old('costo', $producto->costo) }}" oninput="calcularGanancia(1)">
                    </div>
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold">Nombre (Precio 1)</label>
                    <input type="text" name="precio_nombre" class="form-control" placeholder="Ej: Personal, Regular" value="{{ old('precio_nombre', $producto->precio_nombre) }}">
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold">Precio 1 *</label>
                    <div class="input-group">
                        <span class="input-group-text">Bs</span>
                        <input type="text" inputmode="decimal" name="precio" id="precio" class="form-control" required value="{{ old('precio', $producto->precio) }}" oninput="calcularGanancia(1)">
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="mb-3 form-check form-switch p-3 border rounded bg-light-subtle">
                <input type="checkbox" class="form-check-input ms-0" id="toggle_precio_2" name="toggle_precio_2" value="1" {{ old('toggle_precio_2', $producto->precio_2 > 0) ? 'checked' : '' }} onchange="togglePrecioFields(2)">
            ...
            <div id="container_precio_2" class="row mb-3 align-items-end p-3 border rounded" style="display: none;">
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" inputmode="decimal" name="costo_2" id="costo_2" class="form-control" value="{{ old('costo_2', $producto->costo_2) }}" oninput="calcularGanancia(2)">
                    </div>
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted">Nombre (Precio 2)</label>
                    <input type="text" name="precio_2_nombre" class="form-control" placeholder="Ej: Mediana" value="{{ old('precio_2_nombre', $producto->precio_2_nombre) }}">
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted">Precio 2</label>
                    <div class="input-group">
                        <span class="input-group-text text-muted">Bs</span>
                        <input type="text" inputmode="decimal" name="precio_2" id="precio_2" class="form-control" value="{{ old('precio_2', $producto->precio_2) }}" oninput="calcularGanancia(2)">
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <!-- Precio 3 Toggle -->
            <div class="mb-3 form-check form-switch p-3 border rounded bg-light-subtle">
                <input type="checkbox" class="form-check-input ms-0" id="toggle_precio_3" name="toggle_precio_3" value="1" {{ old('toggle_precio_3', $producto->precio_3 > 0) ? 'checked' : '' }} onchange="togglePrecioFields(3)">
            ...
            <div id="container_precio_3" class="row mb-4 align-items-end p-3 border rounded" style="display: none;">
                <div class="col-md-2">
                    ...
                    <div class="input-group">
                        <span class="input-group-text text-muted bg-white">Bs</span>
                        <input type="text" inputmode="decimal" name="costo_3" id="costo_3" class="form-control" value="{{ old('costo_3', $producto->costo_3) }}" oninput="calcularGanancia(3)">
                    </div>
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted">Nombre (Precio 3)</label>
                    <input type="text" name="precio_3_nombre" class="form-control" placeholder="Ej: Familiar" value="{{ old('precio_3_nombre', $producto->precio_3_nombre) }}">
                </div>
                <div class="col-md-3">
                    <label class="small fw-bold text-muted">Precio 3</label>
                    <div class="input-group">
                        <span class="input-group-text text-muted">Bs</span>
                        <input type="text" inputmode="decimal" name="precio_3" id="precio_3" class="form-control" value="{{ old('precio_3', $producto->precio_3) }}" oninput="calcularGanancia(3)">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-2 bg-light border rounded d-flex justify-content-between align-items-center">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" class="form-check-input" id="usa_inventario" name="usa_inventario" value="1" {{ old('usa_inventario', $producto->usa_inventario) ? 'checked' : '' }} onchange="toggleStockField()">
                <label class="form-check-label" for="usa_inventario">Usar Control de Inventario</label>
            </div>

            <div class="mb-3" id="stock_container" style="display: {{ old('usa_inventario', $producto->usa_inventario) ? 'block' : 'none' }};">
                <label>Stock</label>
                <input type="number" step="1" min="0" name="stock" class="form-control" value="{{ old('stock', $producto->stock) }}">
